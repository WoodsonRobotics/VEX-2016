...
#pragma config(Sensor, I2C_1,  ScissorLeft,    sensorQuadEncoderOnI2CPort,    , AutoAssign )
...
#pragma config(Motor,  port8,           ScissorLeft,   tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port9,           ScissorRight,  tmotorVex393_MC29, openLoop, reversed)
